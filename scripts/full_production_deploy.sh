...
# This script does everything: install, deploy, and validate
# Usage: sudo ./scripts/full_production_deploy.sh
...
echo "   - Check production URL: http://45.144.177.203:3000"
echo "   - Verify CSS files load correctly"
echo "   - Check logs if issues: sudo journalctl -u max-signal-frontend -n 50"
echo ""
